...
class PharmacyReportDataServiceRichTest {
    ...
    void executeAllQueries() throws Exception {
        Map<String, Object> dummyRow = new HashMap<>() {{
            ...
            put("summary", "1");
            put(" UNION ALL ", "1");
            put(" ORDER BY sr.return_date, sr.sequence_number", "1");
            put("2025-01-01", "1");
            put("ib", "1");
            put("items", "1");
            put("ps", "1");
