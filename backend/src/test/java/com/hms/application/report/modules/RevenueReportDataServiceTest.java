...
class RevenueReportDataServiceTest {
    ...
    @InjectMocks
    private RevenueReportDataService service;
    ...
    @Test
    void getConsultantRevenueReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            ...
            List<Map<String, Object>> result = service.getConsultantRevenueReport("", "");
    ...
    @Test
    void getDepartmentRevenueReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getDepartmentRevenueReport("", "");
    ...
    @Test
    void getRoomRevenueReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getRoomRevenueReport("", "", UUID.randomUUID());
    ...
    @Test
    void getConsultantRevenueOPIP_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getConsultantRevenueOPIP("", "");
    ...
    @Test
    void getDepartmentRevenueOPIP_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getDepartmentRevenueOPIP("", "");
