...
class EncounterReportDataServiceRichTest {
    ...
    @InjectMocks private EncounterReportDataService service;
    ...
    void executeAllQueries() throws Exception {
        Map<String, Object> dummyRow = new HashMap<>() {{
            ...
            put(",                COUNT(*) AS ", "1");
            put(" ORDER BY ce.started_at::DATE ASC", "1");
