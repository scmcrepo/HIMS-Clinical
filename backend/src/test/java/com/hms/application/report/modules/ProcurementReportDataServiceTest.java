...
class ProcurementReportDataServiceTest {
    ...
    @InjectMocks
    private ProcurementReportDataService service;
    ...
    @Test
    void getPurchaseOrdersReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            ...
            List<Map<String, Object>> result = service.getPurchaseOrdersReport("", "", "", java.util.Map.of());
    ...
    @Test
    void getGoodsReceivedReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getGoodsReceivedReport("", "", "", java.util.Map.of());
    ...
    @Test
    void getGoodsReturnedReport_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getGoodsReturnedReport("", "", "", java.util.Map.of());
