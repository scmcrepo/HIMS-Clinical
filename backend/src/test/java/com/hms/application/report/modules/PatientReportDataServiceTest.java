...
class PatientReportDataServiceTest {
    ...
    @InjectMocks
    private PatientReportDataService service;
    ...
    @Test
    void getPatientRegistrationDaywise_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            ...
            List<Map<String, Object>> result = service.getPatientRegistrationDaywise("", "", "");
    ...
    @Test
    void getPatientRegistrationDetails_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getPatientRegistrationDetails("", "", "");
    ...
    @Test
    void getConsultwiseRegistration_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getConsultwiseRegistration("", "", "");
    ...
    @Test
    void getDepartmentwiseRegistration_ShouldReturnData() {
        try (MockedStatic<ReportDbUtil> mocked = mockStatic(ReportDbUtil.class)) {
            List<Map<String, Object>> dummy = new ArrayList<>();
            Map<String, Object> row = new HashMap<>();
            row.put("Patient", "Test Patient");
            ...
            List<Map<String, Object>> result = service.getDepartmentwiseRegistration("", "", "");
