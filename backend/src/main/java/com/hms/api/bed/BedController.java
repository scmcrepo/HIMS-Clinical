...
@PreAuthorize("hasPermission('BEDMANAGEMENT','') or hasPermission('IN_PATIENT','') or hasPermission('NURSE_IN_PATIENT','') or hasPermission('OUT_PATIENT','') or hasPermission('NURSE_OP_QUEUE','') or hasPermission('OP_QUEUE','') or hasPermission('OP_BILLING','') or hasPermission('IP_BILLING','')")
