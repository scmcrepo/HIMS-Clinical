...
public class InpatientCaseSheetController {
    ...
    public ResponseEntity<ApiResponse<List<VisitDiagnosticOrderResponse>>> listDiagnosticOrders(
        ...
        return ResponseEntity.ok(ApiResponse.ok("OK", consolidateDiagnosticOrders(enrichDiagnosticOrders(encounterId, list))));
    }
    ...
    private List<VisitDiagnosticOrderResponse> enrichDiagnosticOrders(UUID encounterId, List<VisitDiagnosticOrderResponse> list) {
        ...
        try {
            ...
            for (com.hms.domain.diagnostic.model.DiagnosticOrder dbOrder : dbOrders) {
                ...
                Instant orderedAt = dbOrder.getCreatedAt() != null ? dbOrder.getCreatedAt() : Instant.now();
        ...
        for (VisitDiagnosticOrderResponse res : list) {
            if ("RADIOLOGY".equalsIgnoreCase(res.diagnosticType())) {
                if (radioOrder == null) {
                    ...
                    Instant orderedAt = radioOrder.orderedAt() != null ? radioOrder.orderedAt() : res.orderedAt();
                ...
                if (labOrder == null) {
                    ...
                    Instant orderedAt = labOrder.orderedAt() != null ? labOrder.orderedAt() : res.orderedAt();
