...
public class BillingReportDataService {
    ...
    public List<Map<String, Object>> getBillsCancelledDaywise(String fromDate, String toDate) {
        String sql = """
            SELECT
                b.cancelled_at::DATE                        AS cancelled_date,
                COUNT(*)                                    AS cancelled_count,
                ROUND(SUM(b.bill_amount) / 100.0, 2)                 AS gross_cancelled_amount
            FROM bills b
            WHERE b.bill_status = 4
              AND b.cancelled_at::DATE BETWEEN ?::DATE AND ?::DATE
            GROUP BY b.cancelled_at::DATE
            ORDER BY b.cancelled_at::DATE
            """;
        return com.hms.application.report.util.ReportDbUtil.queryForList(jdbcTemplate, sql, fromDate, toDate);
    }
    ...
    public List<Map<String, Object>> getDiscountReport(String fromDate, String toDate, String visit) {
        ...
        sql.append(" ORDER BY b.bill_date ASC, b.created_at ASC");
    ...
    public List<Map<String, Object>> getUnsettledBills(String fromDate, String toDate) {
        String sql = """
            ...
            ORDER BY b.bill_date, balance_due DESC
            """;
        return com.hms.application.report.util.ReportDbUtil.queryForList(jdbcTemplate, sql, fromDate, toDate);
    }
