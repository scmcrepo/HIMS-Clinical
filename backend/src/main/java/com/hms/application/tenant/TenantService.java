...
public class TenantService {
    ...
    private static final List<String[]> FEATURES = List.of(
        ...
        new String[]{"REFERRAL", "CLINICAL", "Referral"},
        ...
        new String[]{"SALES", "PHARMACY", "Sales"},
        new String[]{"SALES_RETURN", "PHARMACY", "Sales Return"},
        new String[]{"SETTINGS_ACCOUNTUNIT", "SETTINGS", "Settings Accountunit"},
        new String[]{"SETTINGS_AREA", "SETTINGS", "Settings Area"},
        ...
        new String[]{"SETTINGS_MOLECULE", "SETTINGS", "Settings Molecule"},
        ...
        new String[]{"SETTINGS_SMS_TEMPLATE", "SETTINGS", "Settings Sms Template"},
        ...
        new String[]{"SETTINGS_TEMPLATE", "SETTINGS", "Settings Template"},
        new String[]{"SETTINGS_UOM", "SETTINGS", "Settings Uom"},
        new String[]{"SETTINGS_USERS", "SETTINGS", "Settings Users"},
        new String[]{"STOCK", "INVENTORY", "Stock"},
        new String[]{"STOCK_ADJUSTMENT", "INVENTORY", "Stock Adjustment"},
        new String[]{"STOCK_CONSUMPTION", "INVENTORY", "Stock Consumption"},
        new String[]{"STOCK_INDENT", "INVENTORY", "Stock Indent"},
        new String[]{"STOCK_ISSUE", "INVENTORY", "Stock Issue"},
        new String[]{"STOCK_RETURN", "INVENTORY", "Stock Return"}
    );
