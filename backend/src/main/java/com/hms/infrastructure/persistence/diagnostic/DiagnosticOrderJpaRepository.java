...
public interface DiagnosticOrderJpaRepository extends JpaRepository<DiagnosticOrder, UUID> {
    @Query("SELECT o FROM DiagnosticOrder o LEFT JOIN FETCH o.lines LEFT JOIN FETCH o.patient WHERE o.encounterId = :eid ORDER BY o.orderDate DESC")
    List<DiagnosticOrder> findByEncounterId(@Param("eid") UUID encounterId);
    
    @Query("SELECT o FROM DiagnosticOrder o LEFT JOIN FETCH o.lines LEFT JOIN FETCH o.patient WHERE o.patientId = :pid ORDER BY o.orderDate DESC")
    Page<DiagnosticOrder> findByPatientId(@Param("pid") UUID patientId, Pageable pageable);
    
    @Query("SELECT o FROM DiagnosticOrder o LEFT JOIN FETCH o.lines LEFT JOIN FETCH o.patient WHERE o.patientId = :pid AND o.testStatus = :testStatus ORDER BY o.orderDate DESC")
    ...
    @Query("SELECT o FROM DiagnosticOrder o LEFT JOIN FETCH o.lines LEFT JOIN FETCH o.patient WHERE o.patientId = :pid AND o.paymentStatus IN :paymentStatuses ORDER BY o.orderDate DESC")
    ...
    @Query("SELECT o FROM DiagnosticOrder o LEFT JOIN FETCH o.lines LEFT JOIN FETCH o.patient WHERE o.diagnosticType = :type AND o.orderDate BETWEEN :from AND :to")
