...
/**
 * One field definition within a CaseSheetTemplate.
 * fieldType drives UI rendering: TEXT | TEXTAREA | NUMBER | SELECT |
 * MULTI_SELECT | DATE | CHECKBOX | RADIO | HEADING
 */
@Entity
@Table(name = "case_sheet_template_fields", indexes = {
    @Index(name = "idx_cstf_template", columnList = "template_id"),
    @Index(name = "idx_cstf_order",    columnList = "template_id, display_order")
})
@Getter @Setter @NoArgsConstructor
/**
 * Tenant scope is carried by the case sheet template through its foreign key.
 ...
 */
public class CaseSheetTemplateField {
