-- V174__update_all_print_templates_minimal.sql
-- Updates all print templates in the database to use SCMC minimal aesthetic, logo, royal blue headers, and compulsory '--End of report--' text where applicable.
...
.header-table{width:100%;border-collapse:collapse;margin-bottom:12px;border-bottom:2px solid #2563eb}
...
.document-title{text-align:center;font-size:13px;font-weight:bold;text-transform:uppercase;text-decoration:underline;color:#1e3a8a;margin:10px 0 15px 0;letter-spacing:1px}
...
.sh{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#1e3a8a;border-bottom:1.5px solid #2563eb;padding-bottom:3px;margin:15px 0 8px 0}
table.items-table{width:100%;border-collapse:collapse;margin-bottom:10px}
table.items-table thead tr{background:#eff6ff;border-top:1px solid #bfdbfe;border-bottom:1px solid #bfdbfe}
table.items-table thead th{padding:6px 8px;font-size:8.5px;font-weight:700;text-transform:uppercase;color:#1e3a8a;text-align:left}
...
.totals-table tr.grand-total{background:#1e3a8a;color:#fff;font-weight:700}
...
table.receipt-table thead tr{background:#eff6ff;border-top:1px solid #bfdbfe;border-bottom:1px solid #bfdbfe}
table.receipt-table thead th{padding:6px 8px;font-size:8.5px;font-weight:700;text-transform:uppercase;color:#1e3a8a;text-align:left}
...
<body><div class="page">
  ...
  <div class="footer">
    ...
    -- ============================================================
    t_ip_receipt := t_receipt; -- identical layout, variable resolution is identical
...
.page{display:flex;flex-direction:column;min-height:100%}
.header-table{width:100%;border-collapse:collapse;margin-bottom:10px;border-bottom:2px solid #2563eb}
...
.hospital-info-td{text-align:left;vertical-align:middle;border:none}
.h-name{font-size:13px;font-weight:700;text-transform:uppercase;color:#1e3a8a}
.h-sub{font-size:8px;color:#4b5563;line-height:1.3;margin-top:2px}
.document-title{text-align:center;font-size:11px;font-weight:bold;text-transform:uppercase;text-decoration:underline;color:#1e3a8a;margin:8px 0 10px 0;letter-spacing:0.5px}
...
table.items-table thead tr{background:#eff6ff;border-top:1px solid #bfdbfe;border-bottom:1px solid #bfdbfe}
table.items-table thead th{padding:4px 5px;font-size:8px;font-weight:700;text-transform:uppercase;color:#1e3a8a;text-align:left}
...
.results-table th{font-size:9.5px;font-weight:700;color:#1e3a8a;padding:8px 6px;text-align:left}
...
.s-hdr{font-size:9.5px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#1e3a8a;border-bottom:1.5px solid #2563eb;padding-bottom:3px;margin-bottom:6px}
...
.imp-body{font-size:10.5px;font-weight:600;line-height:1.6;color:#111827;background:#eff6ff;border-radius:4px;padding:8px;min-height:35px;border-left:3px solid #2563eb}
.end-report{text-align:center;margin:25px 0 10px;font-size:9.5px;color:#4b5563;font-weight:bold;letter-spacing:1px}
.footer{margin-top:auto;padding-top:10px;border-top:1px solid #e5e7eb;display:flex;justify-content:space-between;align-items:flex-end}
.fn{font-size:7.5px;color:#9ca3af;line-height:1.5}
.sig{text-align:right;font-size:9px}
...
.tno{background:#1e3a8a;color:#fff;width:18px;height:18px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;flex-shrink:0}
.tname{font-weight:600;font-size:10px;color:#111827}
.tdept{font-size:8px;color:#6b7280;margin-left:4px}
.spec-tag{background:#fef3c7;border:1px solid #fcd34d;border-radius:3px;padding:1px 5px;font-size:8px;font-weight:600;color:#92400e;margin-left:auto}
.end-report{text-align:center;margin:25px 0 10px;font-size:9.5px;color:#4b5563;font-weight:bold;letter-spacing:1px}
.footer{margin-top:auto;padding-top:10px;border-top:1px solid #e5e7eb;display:flex;justify-content:space-between;align-items:flex-end}
.fn{font-size:7.5px;color:#9ca3af;line-height:1.5}
.sig{text-align:right;font-size:9px}
...
.details-table td .lbl{font-weight:700;color:#4b5563;display:inline-block;min-width:110px}
.section{margin-bottom:12px}
.s-title{background:#1e3a8a;color:#fff;padding:5px 10px;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;border-radius:3px 3px 0 0}
...
<body><div class="page">
  ...
  <table class="receipt-table">
    ...
    <tbody>
      <tr>
        <td>#{data.reason}</td>
        <td class="r" style="font-family:'DM Mono',monospace;font-weight:700;font-size:11px;color:#dc2626">&#8377; #{data.amount}</td>
      </tr>
    </tbody>
  </table>
...
.card{width:80mm;height:49mm;padding:3mm;background:linear-gradient(135deg,#1e3a8a 0%,#1e40af 60%,#2563eb 100%);color:#fff;border-radius:3mm;overflow:hidden;position:relative}
.top{display:flex;align-items:center;margin-bottom:2mm;border-bottom:1px solid rgba(255,255,255,0.2);padding-bottom:1.5mm}
.logo-img{height:20px;max-width:30px;object-fit:contain;margin-right:2mm}
.h-name{font-size:8px;font-weight:700;text-transform:uppercase}
.h-sub{font-size:5px;color:rgba(255,255,255,0.7);line-height:1.2}
.id-badge{background:rgba(255,255,255,.15);border-radius:1.5mm;padding:0.5mm 1.5mm;font-size:5.5px;font-weight:600;letter-spacing:0.5px;text-transform:uppercase;margin-left:auto}
.p-name{font-size:11px;font-weight:800;margin:0.5mm 0;letter-spacing:-.2px}
.pid{font-size:8.5px;font-family:monospace;background:rgba(255,255,255,.12);display:inline-block;padding:0.5mm 1.5mm;border-radius:1mm;margin-bottom:0.5mm}
.info-row{display:flex;gap:3mm;margin-top:0.5mm}
.ii label{font-size:5px;font-weight:700;text-transform:uppercase;letter-spacing:.3px;color:rgba(255,255,255,.6);display:block}
.ii span{font-size:8px;font-weight:600}
.bottom{position:absolute;bottom:2mm;left:3mm;right:3mm;border-top:1px solid rgba(255,255,255,.15);padding-top:1mm;display:flex;justify-content:space-between;align-items:center}
.contact{font-size:5px;color:rgba(255,255,255,.6);line-height:1.2}
.bc-container{display:inline-flex;align-items:center;background:#fff;padding:0 4px;border-radius:0.6mm;height:6mm;justify-content:center;flex-shrink:0;overflow:hidden}
