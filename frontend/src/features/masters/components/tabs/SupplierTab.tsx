                ...
                {editing && (
                  <div className="border-t border-gray-100 pt-4 mt-2 md:col-span-2">
                    ...
                    <div className="flex gap-2 mt-1">
                      <button type="button" onClick={() => setForm(f => ({ ...f, status: 1 }))} className={cn("px-4 py-2 text-xs font-bold rounded-lg border transition-all duration-150", form.status === 1 ? "bg-neutral-600 text-white border-neutral-600 shadow-sm" : "bg-white text-gray-700 border-gray-200 hover:bg-gray-50")}>Active</button>
