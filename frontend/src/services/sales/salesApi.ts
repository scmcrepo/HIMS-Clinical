...
export interface SaleLine { inventoryBatchId: string; quantity: number; unitRate: number; discountAmount?: number; discountType?: string; discountValue?: number; }
export interface CreateSaleCmd { id?: string | undefined; patientId?: string | undefined; customerName?: string | undefined; customerPhone?: string | undefined; consultantName?: string | undefined; encounterId?: string | undefined; prescribedAt?: string | undefined; departmentId: string; isDraft: boolean; discountAmount?: number | undefined; discountType?: string | undefined; discountValue?: number | undefined; lines: SaleLine[]; paymentMode?: string | undefined; cardType?: string | undefined; cardNumber?: string | undefined; bankName?: string | undefined; paidAmount?: number | undefined; }
export interface PharmacySaleResponse { id: string; patientId: string|null; patientName: string; customerName: string|null; customerPhone: string|null; consultantName: string|null; encounterId: string|null; prescribedAt?: string|null; departmentId: string; sequenceNumber: string|null; saleDate: string; totalAmount: number; discountAmount: number; discountType?: string; discountValue?: number; status: string; lines: Array<{id: string; inventoryBatchId: string; itemName: string; quantity: number; unitRate: number; amount: number; discountAmount: number; discountType?: string; discountValue?: number;}>; createdAt?: string; paymentMode?: string|null; cardType?: string|null; cardNumber?: string|null; bankName?: string|null; paidAmount: number; dueAmount: number; payments?: Array<{ id: string; amount: number; paymentMode: string; cardType?: string|null; cardNumber?: string|null; bankName?: string|null; createdAt: string }>; patientNumber?: string|null; customerType?: string; }
...
export const salesApi = {
  ...
  getByDate:    (date: string, q?: string) => api.get<ApiResponse<PharmacySaleResponse[]>>('/sales', { params: { date, q } }).then(r => r.data.data ?? []),
