...
export interface CreateUserCmd { username: string; password?: string; firstName: string; lastName: string; email?: string; roleIds: string[]; departmentIds?: string[]; consultantId?: string | null; showCasesheet?: boolean; speechLanguage?: string; salutation?: string; phoneNo?: string; status?: string; branchId?: string }
