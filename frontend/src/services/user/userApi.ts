...
export interface CreateUserCmd { username: string; password?: string; firstName: string; lastName: string; email?: string; roleIds: string[]; departmentIds?: string[]; showCasesheet?: boolean; speechLanguage?: string; salutation?: string; phoneNo?: string }
